...
private fun WidgetSection() {
    ...
    Card(
        ...
        Column(
            ...
            SettingChipRow(
                title = stringResource(R.string.settings_widget_left_tap_action_label),
                options = listOf(
                    stringResource(R.string.settings_widget_left_tap_action_app),
                    stringResource(R.string.settings_widget_left_tap_action_camera),
                ),
                selectedIndex = if (leftTapApp.action == WidgetPreferences.LEFT_TAP_ACTION_CAMERA) 1 else 0,
                onSelect = { index ->
                    prefs.setLeftTapAction(
                        if (index == 1) WidgetPreferences.LEFT_TAP_ACTION_CAMERA
                        else WidgetPreferences.LEFT_TAP_ACTION_APP,
                    )
                },
                enabled = enabled && leftTapApp.enabled,
            )
            SettingValueRow(
                title = stringResource(R.string.settings_widget_left_tap_label),
                description = if (leftTapApp.action == WidgetPreferences.LEFT_TAP_ACTION_CAMERA) {
                ...
                value = if (leftTapApp.action == WidgetPreferences.LEFT_TAP_ACTION_CAMERA) {
